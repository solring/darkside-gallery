...
function SocialNetworkBtns({color1, color2}) {
  ...
  const totalWidth = width * num + gap * (num-1);

  return (
    <svg viewBox={`0 0 ${totalWidth} ${height}`} xmlns="http://www.w3.org/2000/svg" width={totalWidth}>
      ...
      <g fill="url('#themeGradient')">
        ...
        {/* github */}
        <svg x="0" width={width} viewBox="0 0 496 512">
        ...
        {/* tumblr */}
        <svg version="1.1" id="Layer_1" x={width+gap} width={width}
          viewBox="0 0 352 352" >
        ...
        {/* twitter */}
        <svg version="1.1" id="Layer_1" x={(width+gap)*2} width={width}
